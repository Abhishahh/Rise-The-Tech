      ...
      <section className="text-gray-600 body-font relative" style={{ userSelect: 'auto' }}>
        <div className="container px-5 py-24 mx-auto" style={{ userSelect: 'auto' }}>
          <div className="flex flex-col text-center w-full mb-12" style={{ userSelect: 'auto' }}>
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base" style={{ userSelect: 'auto' }}>Any queries surely Contact Me</p>
          </div>
          <div className="lg:w-1/2 md:w-2/3 mx-auto" style={{ userSelect: 'auto' }}>
            <div className="flex flex-wrap -m-2" style={{ userSelect: 'auto' }}>
              ...
              <div className="p-2 w-full" style={{ userSelect: 'auto' }}>
                <button className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" style={{ userSelect: 'auto' }}>Click to Contact</button>
              </div>
              <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center" style={{ userSelect: 'auto' }}>
                <a className="text-indigo-500" style={{ userSelect: 'auto' }}>abhishek.science92@gmail.com</a>
                <p className="leading-normal my-5" style={{ userSelect: 'auto' }}>Mazgaon,
                  <br style={{ userSelect: 'auto' }} />Mumbai
                </p>
